				...
				try {
					 if(temp_pflegt_TierNameAuswahl==null&&temp_pflegt_PNummerAuswahl==null) {
						 ...
						 if(s.deletPflegt(temp_pflegt_PNummerAuswahl,temp_pflegt_TierNameAuswahl)) {
							 textPane_pflegt_listenausgabe.setText("Pfleger erfolgreich gelï¿½scht"); 
							 refreshComboBoxes();
						 }else {
				...
				try {
					 ...
					 if(temp1.isBlank()) {
						 ...
						 if(s.deletPfleger(temp1)) {
							 textPane_pfleger_listenausgabe.setText("Pfleger erfolgreich gelï¿½scht"); 
							 refreshComboBoxes();
						 }else {
				...
				try {
					 ...
					 if(temp1.isBlank()) {
						 ...
						 if(s.deletGehege(temp1)) {
							 textPane_gehege_listenausgabe.setText("Tier erfolgreich gelï¿½scht"); 
							 refreshComboBoxes();
						 }else {
