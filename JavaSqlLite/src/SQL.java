...
public class SQL {
	...
	public void changePfleger(String PNummer, String Nachname, String Vorname, String Geburtsdatum, String PLZ, String Ort, String StraßeNr, String Tel, String Eintrittsdatum, String Gehalt) {
		...
		Dbmanipulation.insert("UPDATE Pfleger SET Nachname ='"+Nachname+"', Vorname='"+Vorname+"',Geburtsdatum="+GDatum+",PLZ="+plz+",Ort='"+Ort+"',StraßeNr='"+StraßeNr+"',Tel="+tel+",Eintrittsdatum="+EDatum+",Gehalt="+gehalt+" WHERE PNummer = '"+pNummer+"'" );
